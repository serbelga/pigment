...
import dev.sergiobelda.pigment.samples.colorpicker.ColorPickerLazyRowMapSample
...
@Preview
@Composable
private fun ColorPickerLazyRowPreview() {
    ColorPickerLazyRowSample()
}

@Preview
@Composable
private fun ColorPickerLazyRowMapPreview() {
    ColorPickerLazyRowMapSample()
}

@Preview
@Composable
private fun ColorPickerLazyRowSizePreview(
